...
export const export_emails_of_static_drop = httpsCallable(
	functions,
	"export_emails_of_static_drop",
);
export const delete_emails_of_static_drop = httpsCallable(
	functions,
...
export const get_emulator_function_call_url = (name) =>
	`http://localhost:${functions_emulator_port}/${VITE_projectId}/us-central1/${name}`;
