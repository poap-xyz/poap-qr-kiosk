...
export const dev =
	...
	(typeof location !== "undefined" &&
		(location.href.includes("debug=true") || location.href.includes("localhost")));
...
export const wait = (time, error = false) =>
	new Promise((res, rej) => setTimeout(error ? rej : res, time));

/* ///////////////////////////////
// Security helpers
// /////////////////////////////*/
export const remove_script_tags = (string = "") => string.replace(/<.*script.*>/gi, "");
