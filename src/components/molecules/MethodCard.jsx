	...
	return (
		<StyledMethodContainer>
			...
			<MethodContent>
						...
						<TextContainer>
							...
							<MintContainer>
								...
								<Text margin="0">
									{" "}
									Minted:{" "}
									<Number weight="700" color="var(--text-body-1)">
										{event.codes - event.codesAvailable}/{event.codes}
									</Number>
								</Text>
							</MintContainer>
						</TextContainer>
				...
				<EventMeta>
					<MetaCol>
						<Text margin="0" size="14px" lineHeight="1" color="var(--neutral-500)">
							Kiosk:&nbsp;
						</Text>
						<MetaLink
							onClick={() => clipboard(eventLink, "Kiosk link copied to clipboard")}
						>
							<ClippedContent margin="0" size="14px" weight="500">
								{" "}
								{eventLink}
							</ClippedContent>
							<PoapIcon
					...
					{!isMobile && (
						<MetaRow>
							<Text margin="0" size="12px" lineHeight="1" color="var(--warning-400)">
								|
							</Text>
						</MetaRow>
					)}
				...
				<MetaRow>
					...
					<MetaLink
						onClick={() => clipboard(adminLink, "Admin link copied to clipboard")}
					>
						<ClippedContent margin="0" size="14px" weight="500">
							{" "}
							{adminLink}
				...
				<WarningBox>
					...
					<Text
						...
						lineHeight="1.3"
					>
						Never send your kiosk links to anyone!
					</Text>
				</WarningBox>
			</MethodContent>
		</StyledMethodContainer>
