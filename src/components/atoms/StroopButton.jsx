...
const BaseButton = styled.a`
    ...
    :not(:disabled):not(:active):focus-visible ${ ButtonWrapper }, :not(:disabled):not(:active):focus ${ ButtonWrapper } {
        border: 1px solid var(--secondary-6);
        /* padding: var(--spacing-3) calc( var(--spacing-3) - 3px + 1px); */
    }
`

export const StroopButton = ( { disabled, color, background, size, onClick, align_text='center', href, children, tabIndex='0', ...props } ) => {
    ...
    return <BaseButton disabled={ disabled } onClick={ disabled ? null : onClick || open_tab } onKeyDown={ handleKeyDown } size={ size } tabIndex={ tabIndex } { ...props }>
