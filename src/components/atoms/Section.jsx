...
const doodadBeforeConfigurations = [
	...
	{
		url: "/assets/decorations/doodas-l-1.svg",
		width: 90,
		height: 90,
		left: "0",
		top: "0",
	...
	{
		url: "/assets/decorations/doodas-l-2.svg",
		width: 90,
		height: 90,
		left: "0",
		top: "50%",
...
const doodadAfterConfigurations = [
	...
	{
		url: "/assets/decorations/doodas-r-1.svg",
		width: 120,
		height: 128,
		right: "0",
		top: "25%",
	...
	{
		url: "/assets/decorations/doodas-r-2.svg",
		width: 120,
		height: 128,
		right: "0",
		top: "25%",
...
export default styled.section`
	...
	${mixin.md_up`
        ${({ before }) =>
			before &&
			doodadBeforeConfigurations[before] &&
			`
            &::before {
            position: absolute;
            z-index: 0;
	...
	${mixin.md_up`
        ${({ after }) =>
			after &&
			doodadAfterConfigurations[after] &&
			`
            &::after {
            position: absolute;
            z-index: 0;
