...
import {
	...
	FooterImage,
	FullLine,
	StyledDutchBackgroundFullWidth,
	GroupPhoneImage,
	FooterDecorationLeft,
	FooterDecorationRight,
} from "../molecules/HomeDecorations";
				...
				<Container>
					...
					<Row>
						...
						<Col size={2} justify="center" align={isMobile ? "center" : "flex-start"}>
							<H2 size="var(--fs-2xl)" color="var(--primary-600)">
								{t("homepage.hero.subheading")}
							</H2>
							<Text>{t("homepage.hero.description")}</Text>
							{allowAccess && (
								<Button onClick={(f) => navigate("/create")}>
									{t("homepage.createBtn")}
								</Button>
							)}
						</Col>
					</Row>
				...
				<Container>
					...
					>
						<DynamicTag tag="h2" align="center" upper>
							...
							<LayeredText
								color="purple"
								label={t("homepage.whatis.layeredTitle.part2")}
							/>
							<LayeredText label="?" />
						</DynamicTag>
					</Row>
			...
			<Section before={3} height="700px" justify="space-around" direction="row">
				<Container>
					<Row justify="center" align="" margin="1rem 0">
						<H2 size={isTablet ? "32px" : "48px"} align="center">
							{t("homepage.howdo.title")}
						</H2>
					</Row>
					...
					<Row gap="25px">
						<Col>
							<NumberedUps
								number="1"
								title={t("homepage.howdo.one.title")}
								description={t("homepage.howdo.one.description")}
							/>
						</Col>
						<Col>
							<NumberedUps
								number="2"
								title={t("homepage.howdo.two.title")}
								description={t("homepage.howdo.two.description")}
							/>
						</Col>
						<Col>
							<NumberedUps
								number="3"
								title={t("homepage.howdo.three.title")}
								description={t("homepage.howdo.three.description")}
							/>
						</Col>
					</Row>
