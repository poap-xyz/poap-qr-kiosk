...
exports.v1_runtimes = {
	...
	...["128MB", "256MB", "512MB", "1GB", "2GB", "4GB", "8GB"].reduce(
		reduce_memory_declarations,
		{},
	),
...
exports.v2_runtimes = {
	...
	...["128MiB", "256MiB", "512MiB", "1GiB", "2GiB", "4GiB", "8GiB", "16GiB", "32GiB"].reduce(
		reduce_memory_declarations,
		{},
	),
	keep_warm: { minInstances: 1 },
...
exports.validate_runtime_settings = (runtimes, allowed_runtimes, throw_on_fail = true) => {
	...
	const invalid_runtime_keys = runtimes.filter(
		(runtime_key) => !runtime_keys.includes(runtime_key),
	);
